...
#[no_mangle]
pub unsafe extern "C" fn verifirefox_ast_lir_physical_loc_new_general_reg(physical_reg_code: PhysicalRegCode) -> *mut PhysicalLoc {
    let physical_loc = PhysicalLoc::Reg(PhysicalReg::General(physical_reg_code));
    Box::into_raw(Box::new(physical_loc))
}

#[no_mangle]
pub unsafe extern "C" fn verifirefox_ast_lir_physical_loc_new_float_reg(physical_reg_code: PhysicalRegCode) -> *mut PhysicalLoc {
    let physical_loc = PhysicalLoc::Reg(PhysicalReg::Float(physical_reg_code));
    Box::into_raw(Box::new(physical_loc))
}

#[no_mangle]
pub unsafe extern "C" fn verifirefox_ast_lir_physical_loc_new_stack_slot(stack_slot_index: StackSlotIndex) -> *mut PhysicalLoc {
    let physical_loc = PhysicalLoc::StackSlot(stack_slot_index);
    Box::into_raw(Box::new(physical_loc))
}

#[no_mangle]
pub unsafe extern "C" fn verifirefox_ast_lir_physical_loc_new_argument(argument_index: ArgumentIndex) -> *mut PhysicalLoc {
...
#[no_mangle]
pub unsafe extern "C" fn verifirefox_ast_lir_graph_into_handle(graph_ptr: *mut LirGraph) -> Handle<LirGraph> {
    Box::<LirGraph>::from_raw(graph_ptr).into()
}

#[no_mangle]
pub unsafe extern "C" fn verifirefox_ast_lir_graph_clone_handle(graph_handle: &Handle<LirGraph>) -> Handle<LirGraph> {
    graph_handle.clone()
}
...
#[no_mangle]
pub unsafe extern "C" fn verifirefox_ast_lir_node_new(operation_ptr: *mut c_void, operand_capacity: usize, def_capacity: usize, temp_capacity: usize, predecessor_capacity: usize, successor_capacity: usize, is_at_block_start: bool) -> *mut c_void {
    let operation = if operation_ptr.is_null() {
        LirOperation::Other
    } else {
        *(Box::<LirOperation>::from_raw(operation_ptr as *mut _))
    };
    let node = LirNode::new(operation, operand_capacity, def_capacity, temp_capacity, predecessor_capacity, successor_capacity, is_at_block_start);
    Box::into_raw(Box::new(node)) as *mut _
}

#[no_mangle]
pub unsafe extern "C" fn verifirefox_ast_lir_node_push_operand(node_ptr: *mut c_void, operand_ptr: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn verifirefox_ast_lir_node_push_def(node_ptr: *mut c_void, def_ptr: *mut c_void) {
    let node = &mut *(node_ptr as *mut LirNode);
...
#[no_mangle]
pub unsafe extern "C" fn verifirefox_ast_lir_node_push_temp(node_ptr: *mut c_void, temp_ptr: *mut c_void) {
    let node = &mut *(node_ptr as *mut LirNode);
...
#[no_mangle]
pub unsafe extern "C" fn verifirefox_ast_lir_node_push_predecessor(node_ptr: *mut c_void, predecessor_node_id: LirNodeId) {
    let node = &mut *(node_ptr as *mut LirNode);
    node.push_predecessor(predecessor_node_id);
}

#[no_mangle]
pub unsafe extern "C" fn verifirefox_ast_lir_node_push_successor(node_ptr: *mut c_void, successor_node_id: LirNodeId) {
    let node = &mut *(node_ptr as *mut LirNode);
...
#[no_mangle]
pub unsafe extern "C" fn verifirefox_ast_lir_operation_new_move_group(move_group_ptr: *mut c_void) -> *mut c_void {
...
#[no_mangle]
pub unsafe extern "C" fn verifirefox_ast_lir_move_group_push_move(move_group_ptr: *mut c_void, move_ptr: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn verifirefox_ast_lir_move_new(from_ptr: *mut c_void, to_ptr: *mut c_void, ty: LirType) -> *mut c_void {
...
#[no_mangle]
pub unsafe extern "C" fn verifirefox_ast_lir_definition_new_with_reg_policy(virtual_reg: VirtualReg, ty: LirType) -> *mut c_void {
...
#[no_mangle]
pub unsafe extern "C" fn verifirefox_ast_lir_definition_new_with_reuse_input_policy(virtual_reg: VirtualReg, ty: LirType, input: usize) -> *mut c_void {
...
#[no_mangle]
pub unsafe extern "C" fn verifirefox_ast_lir_definition_new_with_fixed_policy(virtual_reg: VirtualReg, ty: LirType, physical_loc_ptr: *mut PhysicalLoc) -> *mut c_void {
...
#[no_mangle]
pub unsafe extern "C" fn verifirefox_ast_lir_allocation_new_static(physical_loc_ptr: *mut PhysicalLoc, use_info_ptr: *mut c_void) -> *mut c_void {
    let physical_loc = *(Box::<PhysicalLoc>::from_raw(physical_loc_ptr));
...
#[no_mangle]
pub unsafe extern "C" fn verifirefox_ast_lir_allocation_new_dynamic(use_info_ptr: *mut c_void) -> *mut c_void {
...
#[no_mangle]
pub unsafe extern "C" fn verifirefox_ast_lir_use_info_new_with_any_policy(virtual_reg: VirtualReg, is_used_at_start: bool, is_recovered_input: bool) -> *mut c_void {
...
#[no_mangle]
pub unsafe extern "C" fn verifirefox_ast_lir_use_info_new_with_reg_policy(virtual_reg: VirtualReg, is_used_at_start: bool) -> *mut c_void {
